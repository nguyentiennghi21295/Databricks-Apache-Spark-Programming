...
# MAGIC %fs head /mnt/dbacademy-datasets/apache-spark-programming-with-databricks/v03/ecommerce/events/events-500k.json/part-00000-tid-309888144738233288-fab86c62-ff9f-4176-98c6-587f95ee9066-2365-1-c000.json
# MAGIC
...
display(dbutils.fs.ls("dbfs:/mnt/dbacademy-users/tien-nghi.nguyen@capgemini.com/apache-spark-programming-with-databricks/delta/events"))
