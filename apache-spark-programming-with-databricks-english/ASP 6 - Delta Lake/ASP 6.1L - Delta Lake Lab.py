...
updated_sales_df = (sales_df
                    .withColumn("items", size(col("items")))
)
...
spark.sql("DESCRIBE HISTORY sales_delta")

# COMMAND ----------

spark.conf.set("spark.databricks.delta.salespath", delta_sales_path)

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP TABLE if exists sales_delta;
# MAGIC CREATE TABLE sales_delta USING DELTA LOCATION '${spark.databricks.delta.salespath}'
# MAGIC
